...
const phonemes: Phoneme[] = [
  ...
  },
  {
    ...
    lipPosition: '特定の形は取らず後続の母音に応じて変わる',
  ...
  },
  {
    ...
    lipPosition: '特定の形は取らない（後続の母音による）',
    tonguePosition: '舌の奥を軟口蓋に押し当てて空気を遮断する',
    exampleWord: 'cat',
    elsaNotation: '/kæt/',
    japaneseApprox: 'カ行',
    description:
  ...
  // Fricatives (9)
  {
    ...
    lipPosition: '上の前歯の先端を下唇の内側に軽く当てる',
    tonguePosition: '特定の位置は取らず自然にリラックス',
    exampleWord: 'fan',
    elsaNotation: '/fæn/',
    japaneseApprox: 'ファ行',
    description:
  ...
  },
  {
    ...
    voicing: '有声',
    articulationPoint: '唇歯',
    lipPosition: '上の前歯を下唇の内側に軽く当てる',
    tonguePosition: '自然な位置でリラックス',
    exampleWord: 'van',
    elsaNotation: '/væn/',
    japaneseApprox: 'ヴァ行',
    description:
  ...
  },
  {
    ...
    voicing: '無声',
    articulationPoint: '歯',
    lipPosition: '自然に開いた状態で力を入れない',
    tonguePosition: '舌先を上下の前歯の間から2〜3mm出し、上の前歯の先端に軽く当てる',
    exampleWord: 'think',
    elsaNotation: '/θɪŋk/',
  ...
  },
  {
    ...
    voicing: '有声',
    articulationPoint: '歯',
    lipPosition: '自然に開いた状態',
    tonguePosition: '舌先を上下の前歯の間に軽く出し、上の前歯の先端に当てる',
    exampleWord: 'this',
    elsaNotation: '/ðɪs/',
  ...
  },
  {
    ...
    voicing: '無声',
    articulationPoint: '歯茎',
    lipPosition: '自然に開いた状態で後続の母音に応じて変わる',
    tonguePosition: '舌先を上の歯茎に非常に近づけるが触れさせない',
    exampleWord: 'sun',
    elsaNotation: '/sʌn/',
    japaneseApprox: 'サ行',
    description:
  ...
  },
  {
    ...
    articulationPoint: '歯茎',
    lipPosition: '自然な状態',
    tonguePosition: '舌先を歯茎に近づけて狭い隙間を作る',
    exampleWord: 'zoo',
    elsaNotation: '/zu/',
    japaneseApprox: 'ザ行',
    description:
  ...
  },
  {
    ...
    lipPosition: '軽く前に突き出して丸める',
    tonguePosition: '舌の前方部分を後部歯茎に近づけ、舌の中央にやや広い溝を作る',
    exampleWord: 'she',
    elsaNotation: '/ʃi/',
    japaneseApprox: 'シャ行',
    description:
  ...
  },
  {
    ...
    voicing: '有声',
    articulationPoint: '後部歯茎',
    lipPosition: '軽く丸めて突き出す',
    tonguePosition: '舌の前方部分を後部歯茎に近づける',
    exampleWord: 'measure',
    elsaNotation: '/mɛʒər/',
  ...
  },
  {
    ...
    lipPosition: '後続の母音に応じて変わる',
    tonguePosition: '特定の位置を取らず後続の母音の位置に準備する',
    exampleWord: 'hat',
    elsaNotation: '/hæt/',
    japaneseApprox: 'ハ行',
    description:
  ...
  // Affricates (2)
  {
    ...
    voicing: '無声',
    articulationPoint: '後部歯茎',
    lipPosition: '唇を軽く丸めて突き出す',
    tonguePosition: '舌先から前方部分を後部歯茎に広く当てて閉鎖し、ゆっくり離す',
    exampleWord: 'church',
    elsaNotation: '/tʃɝtʃ/',
    japaneseApprox: 'チャ行',
    description:
  ...
  },
  {
    ...
    articulationPoint: '後部歯茎',
    lipPosition: '軽く丸めて突き出す',
    tonguePosition: '舌の前方部分を後部歯茎に当てて閉鎖し、声を出しながらゆっくり離す',
    exampleWord: 'judge',
    elsaNotation: '/dʒʌdʒ/',
    japaneseApprox: 'ジャ行',
    description:
  ...
  // Nasals (3)
  {
    ...
    articulationPoint: '両唇',
    lipPosition: '上下の唇をしっかり閉じる',
    tonguePosition: '特定の位置は取らずリラックスした状態',
    exampleWord: 'man',
    elsaNotation: '/mæn/',
    japaneseApprox: 'マ行',
    description:
  ...
  },
  {
    ...
    articulationPoint: '歯茎',
    lipPosition: '特定の形は取らない',
    tonguePosition: '舌先を上の歯茎にしっかり当て口からの空気の流れを遮断する',
    exampleWord: 'no',
    elsaNotation: '/noʊ/',
    japaneseApprox: 'ナ行',
    description:
  ...
  },
  {
    ...
    voicing: '有声',
    articulationPoint: '軟口蓋',
    lipPosition: '特定の形は取らず軽く開いた状態',
    tonguePosition: '舌の奥を軟口蓋に当てて口からの空気を遮断する',
    exampleWord: 'sing',
    elsaNotation: '/sɪŋ/',
  ...
  // Liquids (2)
  {
    ...
    subcategory: 'liquid',
    lipPosition: '特定の形は取らず後続の母音に応じて変わる',
    tonguePosition: '舌先を上の歯茎にしっかり当て、その状態を維持したまま舌の側面から空気を流す',
    exampleWord: 'let',
    elsaNotation: '/lɛt/',
  ...
  },
  {
    ...
    category: 'consonant',
    subcategory: 'liquid',
    lipPosition: '軽く丸めて前に突き出す',
    tonguePosition: '舌先を口の中のどこにも触れさせず、反らせて上方に向けるか舌の中央部を盛り上げる',
    exampleWord: 'red',
    elsaNotation: '/rɛd/',
  ...
  // Glides (2)
  {
    ...
    lipPosition: '唇を強く丸めてすぼめ、小さな円形の開口を作る',
    tonguePosition: '舌の奥を軟口蓋に向かって持ち上げる',
    exampleWord: 'we',
    elsaNotation: '/wi/',
    japaneseApprox: 'ワ行',
    description:
  ...
  },
  {
    ...
    lipPosition: '次の母音に応じて変わるが基本的には横に引き気味',
    tonguePosition: '舌の前部を硬口蓋に近づけ、舌先は下の歯の裏に自然に置く',
    exampleWord: 'yes',
    elsaNotation: '/jɛs/',
    japaneseApprox: 'ヤ行',
    description:
  ...
  },
  {
    ...
    subcategory: 'front-vowel',
    openness: '半狭',
    lipPosition: '横に引くが力は弱め、リラックスした状態',
    tonguePosition: '舌の前部をやや高めにし、力を入れずに弛緩した状態で保つ',
    exampleWord: 'sit',
    elsaNotation: '/sɪt/',
  ...
  },
  {
    ...
    subcategory: 'front-vowel',
    openness: '半広',
    lipPosition: '自然に開いた状態、横にも丸めにもしない',
    tonguePosition: '舌の前部を中程度の高さにし、舌先は下の前歯の裏に軽く触れる',
    exampleWord: 'bed',
    elsaNotation: '/bɛd/',
    japaneseApprox: '「エ」',
    description:
  ...
  },
  {
    ...
    subcategory: 'front-vowel',
    openness: '広',
    lipPosition: '横に広げる（「エ」の口の形のまま大きく開ける）',
    tonguePosition: '舌の前部を低い位置に下げ前方の位置を保つ。舌先は下の前歯の裏に触れたまま',
    exampleWord: 'cat',
    elsaNotation: '/kæt/',
  ...
  // Central Vowels (3)
  {
    ...
    openness: '中央（弱）',
    lipPosition: '力を入れず自然に半開きの状態。丸めも引きもしない',
    tonguePosition: '口の中央、中程度の高さのニュートラルポジション。前にも後ろにも偏らない',
    exampleWord: 'about',
    elsaNotation: '/əbaʊt/',
  ...
  },
  {
    ...
    subcategory: 'central-vowel',
    openness: '半広',
    lipPosition: '自然に開いた状態で丸めも引きもしない',
    tonguePosition: '舌は中央のやや後方、中程度の高さ。舌先は下の歯の裏あたり',
    exampleWord: 'cup',
    elsaNotation: '/kʌp/',
  ...
  },
  {
    ...
    subcategory: 'central-vowel',
    openness: '中央（R音化・強勢）',
    lipPosition: 'やや丸めて軽く突き出す',
    tonguePosition: '舌全体をやや後方に引き中央部を盛り上げる。舌先はどこにも触れない',
    exampleWord: 'bird',
    elsaNotation: '/bɝd/',
  ...
  // Back Vowels (4)
  {
    ...
    openness: '狭（閉）',
    lipPosition: 'しっかりと丸めて前に突き出し、小さな円形の開口を作る',
    tonguePosition: '舌の奥を軟口蓋に向かって高く持ち上げる。舌先は下の前歯から離れる',
    exampleWord: 'boot',
    elsaNotation: '/but/',
  ...
  },
  {
    ...
    subcategory: 'back-vowel',
    openness: '半狭',
    lipPosition: '軽く丸めるが強く突き出さない緩んだ丸め',
    tonguePosition: '舌の奥部分をやや高めだが中央寄りの位置に置き、力を抜いた状態',
    exampleWord: 'foot',
    elsaNotation: '/fʊt/',
  ...
  },
  {
    ...
    subcategory: 'back-vowel',
    openness: '半広',
    lipPosition: 'しっかりと丸め、口を大きく縦に開く',
    tonguePosition: '舌の奥を中程度の高さに持ち上げる。舌先は下の前歯から離れた自然な位置',
    exampleWord: 'thought',
    elsaNotation: '/θɔt/',
  ...
  },
  {
    ...
    subcategory: 'back-vowel',
    openness: '広',
    lipPosition: '丸めず自然に開いた状態',
    tonguePosition: '舌を低く平らにしやや後方に引く。舌全体がリラックスして口の底に沈んだ状態',
    exampleWord: 'father',
    elsaNotation: '/fɑðər/',
  ...
  // === Diphthongs (5) ===
  {
    ...
    movement: '前舌→狭',
    lipPosition: '自然に開いた状態から口を閉じる方向に変化する',
    tonguePosition: '舌の前部を中程度の高さから、やや高い前方の位置へ持ち上げていく',
    exampleWord: 'say',
    elsaNotation: '/seɪ/',
    japaneseApprox: '「エイ」',
    description:
  ...
  },
  {
    ...
    subcategory: 'diphthong',
    movement: '広→狭',
    lipPosition: '自然に開いた状態から横に引かれる方向に変化する',
    tonguePosition: '低い位置から舌の前部を高く持ち上げていく',
    exampleWord: 'time',
    elsaNotation: '/taɪm/',
    japaneseApprox: '「アイ」',
    description:
  ...
  },
  {
    ...
    subcategory: 'diphthong',
    movement: '後舌→狭',
    lipPosition: '丸めた唇から横に引いた形へ変化する',
    tonguePosition: '舌の奥が中程度の高さから、舌の前部を持ち上げていく',
    exampleWord: 'boy',
    elsaNotation: '/bɔɪ/',
    japaneseApprox: '「オイ」',
    description:
  ...
  },
  {
    ...
    subcategory: 'diphthong',
    movement: '後舌→狭',
    lipPosition: '中程度に丸めた唇からさらにすぼめて小さく丸める',
    tonguePosition: '舌の奥を中程度の高さから高い位置へ持ち上げる',
    exampleWord: 'go',
    elsaNotation: '/goʊ/',
    japaneseApprox: '「オウ」',
    description:
  ...
  },
  {
    ...
    subcategory: 'diphthong',
    movement: '広→後舌狭',
    lipPosition: '自然に開いた状態から丸めてすぼめる方向に劇的に変化する',
    tonguePosition: '低い位置から舌の奥を高く持ち上げていく',
    exampleWord: 'now',
    elsaNotation: '/naʊ/',
    japaneseApprox: '「アウ」',
    description:
  ...
  // === R-colored Vowels (7) ===
  {
    ...
    lipPosition: 'やや丸めて軽く突き出す',
    tonguePosition: '舌の中央部を持ち上げて盛り上げ、舌先はどこにも触れない',
    exampleWord: 'bird',
    elsaNotation: '/bɝd/',
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: 'わずかに丸める程度',
    tonguePosition: '舌を反らせるか中央を盛り上げるが弱く控えめに',
    exampleWord: 'butter',
    elsaNotation: '/bʌtər/',
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: '最初は丸めず大きく開け、R音に向けてやや丸めに移行',
    tonguePosition: '舌を低く平らにした状態からR音の構えに移行する',
    exampleWord: 'car',
    elsaNotation: '/kɑr/',
    japaneseApprox: '「アー」＋舌巻き',
    description:
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: '丸めた唇を維持しながらR音を出す',
    tonguePosition: '舌の奥を中程度の高さにした状態からR音の構えに移行する',
    exampleWord: 'door',
    elsaNotation: '/dɔr/',
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: 'やや横に引いた状態から軽く丸めの方向に変化する',
    tonguePosition: '舌の前部をやや高めの位置からR音の構えに移行する（前方から中央への大きな動き）',
    exampleWord: 'here',
    elsaNotation: '/hɪr/',
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: '自然に開いた状態からR音で軽く丸めの方向へ',
    tonguePosition: '舌の前部を中程度の高さからR音の構えに移行する',
    exampleWord: 'there',
    elsaNotation: '/ðɛr/',
  ...
  },
  {
    ...
    category: 'r-colored',
    subcategory: 'r-colored-vowel',
    lipPosition: '軽く丸めた状態を全体的に維持する',
    tonguePosition: '舌の奥をやや高めにした状態からR音の構えに移行する',
    exampleWord: 'sure',
    elsaNotation: '/ʃʊr/',
